...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx3a7e3834b735a82e',

  // 使用微信测试号时才需要填写：公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '5743dab085a5e8f0183139816313d2f1',
  ...
  USERS: [
    {
      ...
      id: 'o64ua5nrAzm3dlKiXKyWOijnHWIk',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      // 使用其他通道时，请填写 config/template-config.cjs 中某个想要使用的模板的id
      useTemplateId: 't-3dFpn5tyxsdOVeHiLDTkwJgTu-vARZEvZTIir4IHY',
      // 所在省份或城市，也可以不填
      province: '山东',
      // 所在城市或县区
      city: '滕州',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '2001', date: '01-02',
        },
        {
        ...
        {
          type: '节日', name: '被搭讪纪念日', year: '2020', date: '10-21',
        }
      ],
  ...
  CALLBACK_TEMPLATE_ID: 'igfNnnNK2ZveHIUIQMNPoxFo9yBOOCgKbtHzgKeZwNA',
  ...
  CALLBACK_USERS: [
    {
      ...
      // 使用其他通道时，请严格按照各个通道的教程进行填写
      id: 'o64ua5gwzc8S7h0lC1v-QS9-YPD4',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
